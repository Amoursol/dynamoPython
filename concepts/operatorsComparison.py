...
greaterThanOrEqualTo = 10 >= 10 # Is '10' greater than or equal to '10' ? Evaluates to True
lessThan = 5 < 10 # Is '5' less than '10' ? Evaluates to True
lessThanOrEqualTo = 5 <= 5 # Is '5' less than or equal to '5' ? Evaluates to True
...
OUT = greaterThan, greaterThanOrEqualTo, lessThan, lessThanOrEqualTo, equals, notEquals, y
