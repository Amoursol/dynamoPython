...
# You have to use either a For loop or List Comprehension to get items from a series of indices
...
getLastItemPopMethod = numbers.pop() # Getting the last item in a list using the 'pop' method
