...
# NOTES: 
# To utilise either the 'key' or 'reverse' optional parameters, you must use the correct syntax of: key = x, or reverse = True
...
# Sorting our output list using the itemgetter operator which simply states sort by indices in this order: Index 1 first, then index 2 second, then follow on with natural sorting afterwards
