...
__version__ = '1.0.0'
"""
Since we are typically building our python scripts to work over a list of items, it is very important to account for it in our code within Python. Often times Dynamo will give you a single item and Python will not know what to do with it if it is expecting a list. The below def will allow for this conversion.
"""
